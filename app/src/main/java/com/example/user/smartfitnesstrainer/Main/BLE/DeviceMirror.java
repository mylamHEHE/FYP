...
import static com.example.user.smartfitnesstrainer.Main.BLE.BleConstant.MSG_CONNECT_RETRY;
import static com.example.user.smartfitnesstrainer.Main.BLE.BleConstant.MSG_CONNECT_TIMEOUT;
import static com.example.user.smartfitnesstrainer.Main.BLE.BleConstant.MSG_READ_DATA_RETRY;
import static com.example.user.smartfitnesstrainer.Main.BLE.BleConstant.MSG_READ_DATA_TIMEOUT;
import static com.example.user.smartfitnesstrainer.Main.BLE.BleConstant.MSG_RECEIVE_DATA_RETRY;
import static com.example.user.smartfitnesstrainer.Main.BLE.BleConstant.MSG_RECEIVE_DATA_TIMEOUT;
import static com.example.user.smartfitnesstrainer.Main.BLE.BleConstant.MSG_WRITE_DATA_RETRY;
import static com.example.user.smartfitnesstrainer.Main.BLE.BleConstant.MSG_WRITE_DATA_TIMEOUT;
    ...
    private BluetoothGattCallback coreGattCallback = new BluetoothGattCallback() {
        ...
        public void onServicesDiscovered(final BluetoothGatt gatt, final int status) {
            ...
            if (status == 0) {
                ...
                //mylam connectFailure(new ConnectException(gatt, status));
            }
        }
