    ...
    private void init() {
        ...
        fab.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(NewScanActivity.this, DeviceScanActivity.class);
        ...
        deviceLv.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int position, long l) {
                ...
                Intent intent = new Intent(NewScanActivity.this, DeviceControlActivity.class);
    ...
    public void showConnectedDevice(ConnectEvent event) {
        if (event != null) {
            ...
            if (event.isDisconnected()) {
                ToastUtil.showToast(NewScanActivity.this, "Disconnect!");
            }
        }
    }
